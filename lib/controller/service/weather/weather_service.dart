...
abstract class WeatherRemoteDatabase {
  ...
  Future<List<WeatherEntity>> fetchForecastDaily(LocationEntity locationEntity);
  Future<WeatherEntity> fetchCurrent(LocationEntity locationEntity);
}

class WeatherService extends WeatherRemoteDatabase {
  @override
  Future<WeatherEntity> fetchCurrent(LocationEntity locationEntity) async {
