...
class _FieldScreenState extends State<FieldScreen> {
        ...
        return Wrap(
          children: [
            SizedBox(
                ...
                height: 600,
                child: SingleChildScrollView(child: FieldDialog())),
          ],
        );
      },
    );
  ...
  Widget buildCurrentLocation() => FutureBuilder(
  ...
  Widget buildContent() => Stack(
        children: [buildGoogleMap(), buildAnimatedContainer()],
      );
    ...
    return GoogleMap(
      ...
      polygons: <Polygon>{
        Polygon(
            ...
            points: listPolyLine.isEmpty ? polylines : listPolyLine,
            fillColor: Colors.blueAccent.withOpacity(0.2),
            strokeColor: Colors.blueAccent,
            geodesic: true,
            strokeWidth: 4),
        Polygon(
            polygonId: const PolygonId('_id1'),
            points: list1,
